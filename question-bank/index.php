...
<div class="section bg">
  <div class="container">
    ...
    <div class="col three bg nopad pointer">
      ...
      <h1 class="feature">Class 6</h1>
      
    </div>
    <div class="col three bg nopad pointer">
      <div class="imgholder"></div>
      <h1 class="feature">Class 7</h1>
      
    </div>
    <div class="col three bg nopad pointer">
      <div class="imgholder"></div>
      <h1 class="feature">Class 8</h1>
      
    </div>
    <div class="group margin"></div>
    <div class="col three bg nopad pointer">
      <div class="imgholder"></div>
      <h1 class="feature">Class 9</h1>
      
    </div>
    <div class="col three bg nopad pointer">
      <div class="imgholder"></div>
      <h1 class="feature">Class 10</h1>
      
    </div>
    <div class="col three bg nopad pointer">
      <div class="imgholder"></div>
      <h1 class="feature">Class 11</h1>
